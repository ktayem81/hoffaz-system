...
public class SemesterDao extends ConnectionDao{    
    ...
    public ArrayList<Semester> buildSemesters(int branchId, int centerId)
        ...
        try {
            ...
            String sql = "SELECT S.ROWID,S.BRANCHID,B.BRANCHNAME,S.CENTERID,C.CENTERNAME,S.SEMESTER_ID,SD.SEMESTER_DESC AS LOOKUP,S.SEMESTER_YEAR,S.SEMESTER_DESC,S.SEMESTER_BEGIN,S.SEMESTER_END,S.INSERTEMPLOYEEID,S.INSERTDATE,S.INSERTHOSTIP,S.INSERTHOSTOS,S.UPDATEMPLOYEEID,S.UPDATEDATE,S.UPDATEHOSTIP,S.UPDATEHOSTOS "
                       + " FROM SEMESTERS S "
    ...
    private Semester populateSemester(ResultSet rs) throws SQLException {
        ...
        semester.setRowId(rs.getString("ROWID"));
